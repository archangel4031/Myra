...
Refer to the [wiki pages](https://github.com/archangel4031/Myra/wiki) on how to use the plugin in its current state. Documentation is still in progress and things may change without notice.
